...
// export default SetafConsolidationPrincipal;
...
useEffect(() => {
  const demo=async()=>{
    const url="http://localhost:1234"
try{
  pesf=await axios.get(`${url}/setaf/patentrecs`)
...
useEffect(() => {
  const demo=async()=>{
    const url="http://localhost:1234"
try{
  fdpres=await axios.get(`${url}/setaf/fdpsdp/principalrecs`)
...
useEffect(() => {
  const demo=async()=>{
    const url="http://localhost:1234"
try{
  eres=await axios.get(`${url}/setaf/econtentrecs`)
...
useEffect(() => {
  const demo=async()=>{
    const url="http://localhost:1234"
try{
  eres=await axios.get(`${url}/setaf/industryrecs`)
...
useEffect(() => {
  const demo=async()=>{
    const url="http://localhost:1234"
try{
  ares=await axios.get(`${url}/setaf/awardatnational/principaldashboard`)
...
useEffect(() => {
  const demo=async()=>{
    const url="http://localhost:1234"
try{
  pres=await axios.get(`${url}/setaf/proposalrecs`)
...
useEffect(() => {
  const demo=async()=>{
    const url="http://localhost:1234"
try{
  bres=await axios.get(`${url}/setaf/books/principaldashboard`)
...
const deptID=logged.dept_id;
try{
  colres=await axios.get(`${url}/setaf/collaborativerecs`)
...
useEffect(() => {
  const demo=async()=>{
    const url="http://localhost:1234"
try{
  vlres=await axios.get(`${url}/setaf/visittolibraryrecs`)
...
useEffect(() => {
  const demo=async()=>{
    const url="http://localhost:1234"
try{
  smres=await axios.get(`${url}/setaf/Motivationrecs`)
...
const deptID=logged.dept_id;
try{
  psres=await axios.get(`${url}/setaf/professionalrecs`)
...
useEffect(() => {
  const demo=async()=>{
    const url="http://localhost:1234"
try{
  sfres=await axios.get(`${url}/setaf/fieldworkrecs`)
